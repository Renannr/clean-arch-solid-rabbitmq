...
describe('CreateClientUseCase', () => {
  it('should create a client and publish a message', async () => {
    ...
    const mockClient = { name: 'João', email: 'joao@email.com', phone: '123456789' };
    ...
    expect(mockRepo.create).toHaveBeenCalledWith(expect.objectContaining(mockClient));
    expect(mockPublisher.publish).toHaveBeenCalledWith('cliente_cadastrado', createdClient);
